...
function DashboardPage() {
  ...
  const handleAccionDashboard = (tipoAccion) => {
    switch (tipoAccion) {
      ...
      case 'solicitudes': navigate('/solicitudes'); break;
      default: break;
    }
  };
      ...
      <div className="max-w-[1500px] mx-auto px-6 lg:px-12 pt-10 flex flex-col items-center">
        ...
        <div className="w-full max-w-[660px] bg-white border border-[#e2e8f0] p-8 rounded-[32px] shadow-[0_20px_50px_rgba(15,31,51,0.06)] mb-12 relative z-10 flex flex-col items-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-11 w-full pb-2">
            ...
            {isModerator && (
              <div className="flex flex-col items-center gap-2.5 cursor-pointer" onClick={() => handleAccionDashboard('solicitudes')}>
                <div className="w-14 h-14 flex items-center justify-center rounded-full bg-white border border-[#e2e8f0] hover:border-amber-400 text-[#3D4F6E] transition-all">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 9h.008v.008H9V9Zm0 3h.008v.008H9V12Zm0 3h.008v.008H9V15Zm0-6h3.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                </div>
                <span className="text-[11px] font-bold text-[#5d6f82]">Solicitudes</span>
              </div>
            )}
          </div>
        </div>
